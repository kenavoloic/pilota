...
const jsonNotes = version => {
  return {
    ...
    "Interface" : "L’onglet de couleur permet de sélectionner la couleur d’une équipe. Un clic sur le score ou sur le bouton [Plus] permet d’ajouter un point. [Moins] retranche un point. [Zéro] ramène le score à zéro.",
    "Langages": "HTML5, CSS3 et JavaScript."
  };
};
